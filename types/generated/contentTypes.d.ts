...
export interface ApiCarritoCarrito extends Schema.CollectionType {
  ...
  attributes: {
    cantidadProductos: Attribute.Integer;
    grandTotal: Attribute.Integer;
...
export interface ApiFiltroFiltro extends Schema.CollectionType {
  ...
  attributes: {
    title: Attribute.String;
    sub_filtros: Attribute.Relation<
      'api::filtro.filtro',
      'oneToMany',
      'api::sub-filtro.sub-filtro'
    >;
    subsub_categories: Attribute.Relation<
      'api::filtro.filtro',
      'manyToMany',
...
export interface ApiProductoProducto extends Schema.CollectionType {
  ...
  attributes: {
    ...
    carrito: Attribute.Relation<
      ...
      'api::carrito.carrito'
    >;
    subsub_categorie: Attribute.Relation<
      'api::producto.producto',
      'manyToOne',
      'api::subsub-categorie.subsub-categorie'
    >;
    sub_filtros: Attribute.Relation<
      ...
      'api::sub-filtro.sub-filtro'
    >;
    slug: Attribute.UID<'api::producto.producto', 'title'>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiSubCategoriaSubCategoria extends Schema.CollectionType {
  ...
  attributes: {
    ...
    >;
    description: Attribute.Text;
    url_image: Attribute.Media;
    slug: Attribute.UID<'api::sub-categoria.sub-categoria', 'title'>;
    subsub_categories: Attribute.Relation<
      'api::sub-categoria.sub-categoria',
      'oneToMany',
      'api::subsub-categorie.subsub-categorie'
...
export interface ApiSubFiltroSubFiltro extends Schema.CollectionType {
...
export interface ApiSubsubCategorieSubsubCategorie
  extends Schema.CollectionType {
  ...
  attributes: {
    ...
    productos: Attribute.Relation<
      ...
      'api::producto.producto'
    >;
    slug: Attribute.UID<'api::subsub-categorie.subsub-categorie', 'title'>;
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::sub-filtro.sub-filtro': ApiSubFiltroSubFiltro;
      'api::subsub-categorie.subsub-categorie': ApiSubsubCategorieSubsubCategorie;
    }
  }
}
